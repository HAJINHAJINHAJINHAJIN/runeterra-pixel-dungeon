...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.BFSWORD, new Lucky().glowing()), "Lucky Enchantment",
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.LONGSWORD, new Wayward().glowing()), "Wayward curse",
	...
	public static void add_v0_6_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(ItemSpriteSheet.GUINSOOS_RAGEBLADE, null), "Weapon and Glyph buffs",
